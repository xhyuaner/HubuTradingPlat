...
const (
	...
	Goods_BatchGetGoodsByCates_FullMethodName = "/Goods/BatchGetGoodsByCates"
...
type GoodsClient interface {
	...
	BatchGetGoodsByCates(ctx context.Context, in *BatchCategoriesIdInfo, opts ...grpc.CallOption) (*GoodsListResponse, error)
...
func (c *goodsClient) BatchGetGoodsByCates(ctx context.Context, in *BatchCategoriesIdInfo, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	out := new(GoodsListResponse)
	err := c.cc.Invoke(ctx, Goods_BatchGetGoodsByCates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoodsServer interface {
	...
	BatchGetGoodsByCates(context.Context, *BatchCategoriesIdInfo) (*GoodsListResponse, error)
...
func (UnimplementedGoodsServer) BatchGetGoodsByCates(context.Context, *BatchCategoriesIdInfo) (*GoodsListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchGetGoodsByCates not implemented")
}
...
func _Goods_BatchGetGoodsByCates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchCategoriesIdInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServer).BatchGetGoodsByCates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Goods_BatchGetGoodsByCates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).BatchGetGoodsByCates(ctx, req.(*BatchCategoriesIdInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Goods_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchGetGoodsByCates",
			Handler:    _Goods_BatchGetGoodsByCates_Handler,
		},
		{
