...
func main() {
	dsn := "root:Hadoop2!@tcp(192.168.88.105:3306)/mxshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
...
func Mysql2Es() {
	...
	host := "http://192.168.88.105:9200"
	logger := log.New(os.Stdout, "xhyuaner--", log.LstdFlags)
